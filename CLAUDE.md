...
Scripts live in the portal repo at `~/Desktop/game/.claude/scripts/` — no local copies, no machine setup needed. From inside this repo the slug is auto-detected from the git remote.
